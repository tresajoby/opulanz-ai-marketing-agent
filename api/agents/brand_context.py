...
class BrandContextAgent:
    ...
    def _build_user_prompt(
        ...
        return (
            ...
            "IMPORTANT RULES: NO human faces, NO people — focus entirely on the SERVICE, PRODUCT, or BRAND CONCEPT. "
            "Include ALL of the following: "
            "(1) Hero subject — the product, service object, or a creative visual metaphor for the brand offering (not a person); "
            "(2) Brand visual identity — incorporate the brand colors explicitly; use design elements, textures, or patterns "
            "that evoke the brand logo style and visual language; "
            "(3) Setting and props — specific environment, surfaces, materials that reinforce premium brand quality; "
            "(4) Visual style — photorealistic product photography, architectural render, abstract 3D, or editorial flat-lay; "
            "(5) Lighting — describe exact lighting setup (e.g. soft diffused studio light, dramatic side lighting, natural window light); "
            "(6) Composition — close-up macro, overhead flat-lay, 3/4 angle product shot, wide environmental shot; "
            "(7) Mood — premium, trustworthy, innovative, aspirational — expressed through color, texture, and space; "
            "(8) Creative concept — a unique visual metaphor or artistic direction that makes the image stand out. "
            "Do NOT include any text, words, letters, logos, or human figures in the image.]\n"
            "---END VARIANT---\n"
        )
